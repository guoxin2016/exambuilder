 ...
 */
@Entity
@Table(name = "tb_old_exams")
public class TopicMenuOldExam implements Serializable {
	...
	private Integer id;
	private String name; // 真题名称
	private String uuid; // 真题uuid
	@Column(name = "[desc]")
	private String desc; // 真题描述
	private String plan_uuid; // 真题描述
	private int status; // 真题状态
	private Date create_time; // 真题创建时间
	private String third_party_paper_id; // 真题创建时间
