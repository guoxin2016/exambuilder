 ...
 */
@Entity
@Table(name = "tb_mistake_collection")
public class MistakeCollection implements Serializable {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -6691715403173753366L;
	
	@Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Integer id;
    private String uuid;    			//用户名
    private String uuid2;    			//错题内容uuid 比如 题目，咨询
    private String plan_uuid;       	//用户邮箱
    private String menu_uuid;   		//电话号码
    private int type;       			//1:章节练习  3:真题 4:必做 5:模拟考试
